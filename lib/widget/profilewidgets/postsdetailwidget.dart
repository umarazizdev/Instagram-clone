...
import '../homewidgets/commentswidget.dart';
import '../savedwidgets/savewidget.dart';

class PostsDetailWidget extends StatefulWidget {
  final String uname;
  const PostsDetailWidget({
    super.key,
    required this.uname,
  });

  @override
  State<PostsDetailWidget> createState() => _PostsDetailWidgetState();
}

class _PostsDetailWidgetState extends State<PostsDetailWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('posts')
          .where('uid', isEqualTo: widget.uname)
          .snapshots(),
